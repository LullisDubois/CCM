class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage("car explosion", carExplosionImage);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("car explosion", carExplosionImage);
